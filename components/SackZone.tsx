  ...
  return (
    <div className="container mx-auto px-4 mb-16 relative z-10">
      <div id="sack-zone-card" className="bg-white dark:bg-slate-800 rounded-xl shadow-xl border-t-4 border-red-600 relative overflow-hidden group">
        ...
        <ShareSnapshot targetId="sack-zone-card" className="absolute top-6 right-6 z-30" />
        ...
        <div className="p-6 pb-2 relative z-10">
           <div className="flex items-center justify-between mb-2">
              ...
              <span className="bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-[10px] font-bold px-2 py-1 rounded border border-red-200 dark:border-red-800 uppercase tracking-wider">
                 P45 Index
              </span>
           </div>
                    ...
                    <div className="relative z-10 grid grid-cols-12 gap-4 items-center">
                       ...
                       <div className="col-span-5 sm:col-span-4 flex items-center gap-3">
                          ...
                          <div>
                             ...
                             <div className="text-[10px] font-black uppercase text-slate-400">{manager.team}</div>
                          </div>
                       </div>
                       ...
                       <div className="col-span-7 sm:col-span-5">
                          <div className="flex justify-between items-center mb-1.5">
                             ...
                             <span className="text-[10px] font-mono font-bold text-slate-500 dark:text-slate-400">{manager.temperature}% Pressure</span>
                          </div>
                          ...
                          <p className="text-[10px] italic text-slate-500 dark:text-slate-400 mt-2 line-clamp-1 border-l-2 border-slate-300 dark:border-slate-600 pl-2">
                       ...
                       <div className="hidden sm:block sm:col-span-3 text-right pl-2 border-l border-slate-100 dark:border-slate-700/50">
                          <div className="text-[9px] uppercase font-bold text-slate-400 mb-0.5">Rumoured Replacement</div>
                          <div className="text-xs font-bold text-primary dark:text-accent truncate mb-1">{manager.nextManager}</div>
                          <span className="inline-block bg-slate-100 dark:bg-slate-700 px-2 py-0.5 rounded text-[10px] font-mono font-bold text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
                              Odds: {manager.odds}
                          </span>
                       </div>
                    </div>
