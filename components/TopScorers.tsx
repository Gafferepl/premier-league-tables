...
const TopScorers: React.FC<TopScorersProps> = ({ data }) => {
  ...
  return (
    <section id="top-scorers" className="py-16 md:py-24 bg-white dark:bg-dark relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-heading font-bold mb-4 text-primary dark:text-white inline-block relative pb-2">
            Golden Boot Table <span className="text-accent">2025/26</span>
        ...
        <div ref={containerRef} className="max-w-5xl mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700 relative">
          ...
          <ScreenshotButton targetRef={containerRef} label="Snap Scorers" />
          ...
          <div className="divide-y divide-slate-100 dark:divide-slate-700">
            {isLoading ? (
               // Loading Skeleton
               [...Array(6)].map((_, i) => (
                 <div key={i} className="grid grid-cols-12 items-center py-4 px-4 md:px-6 animate-pulse">
                    <div className="col-span-1 flex justify-center"><div className="w-4 h-6 bg-slate-200 dark:bg-slate-700 rounded"></div></div>
                    <div className="col-span-5 md:col-span-4 flex items-center gap-4">
                       <div className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 shrink-0"></div>
                       <div className="h-4 w-32 bg-slate-200 dark:bg-slate-700 rounded"></div>
                    </div>
                    <div className="col-span-2 hidden md:flex justify-center"><div className="w-8 h-8 rounded bg-slate-200 dark:bg-slate-700"></div></div>
                    <div className="col-span-2 flex justify-center"><div className="w-8 h-8 rounded bg-slate-200 dark:bg-slate-700"></div></div>
                    <div className="col-span-4 md:col-span-3 flex justify-end"><div className="h-4 w-24 bg-slate-200 dark:bg-slate-700 rounded"></div></div>
                 </div>
               ))
            ) : (
                    ...
                    <div className="relative bg-gradient-to-br from-primary to-blue-900 rounded-xl p-1 shadow-lg overflow-hidden text-white flex flex-col">
                       ...
                       <div className="relative z-10 p-4 h-full flex flex-col">
                          ...
                          <a 
                            ...
                            className="mt-4 bg-accent hover:bg-[#f50057] text-white py-2 px-4 rounded-lg font-bold text-center text-sm shadow-lg transition-transform hover:-translate-y-1 flex items-center justify-center gap-2"
                          ...
                          <div className="text-[9px] text-center mt-2 text-white/40">
                             *Affiliate Link. Helps pay for the servers (and my pies).
                          </div>
                       </div>
                    </div>
